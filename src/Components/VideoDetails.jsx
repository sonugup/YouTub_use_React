...
const VideoDetails = () => {
  ...
  const fetchVideoDetels = () => {
    ...
    setLoading(true);
    fetchYoutubapi(`video/details/${id}`).then((res) => {
      console.log(res);
      setVideo(res)
      setLoading(false)
    })
  ...
  return (
    <div className="flex justify-center flex-row h-[calc(100%-56px)] bg-black">
      <div className="w-full max-w-[1280px] flex flex-col lg:flex-row ">
        <div className="flex flext-col lg:w-[calc(100%-350px)] xl:w-[calc100%-400px] px-4 py-3 lg:py-6 overflow-y-auto" >
          ...
          <div className="flext justify-between flex-col md:flex-row mt-4 ">
            <div className="flex">
